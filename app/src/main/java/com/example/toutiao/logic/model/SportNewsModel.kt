...
data class SportNewsModel(val ret: Int, val ids: List<Id>, val newslist: List<SportNewsList>) {

    data class Id(val id: String, val comments: Int)

    data class SportNewsList(val title: String, val time: String, val source: String, val url: String,
