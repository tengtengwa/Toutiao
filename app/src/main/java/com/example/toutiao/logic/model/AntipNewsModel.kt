...
data class AntipNewsModel(val ret: Int, val ids: List<Id>, val newslist: List<AntipNewsList>) {

    data class Id(val id: String, val comments: Int)

    data class AntipNewsList(val title: String, val time: String, val source: String, val url: String,
